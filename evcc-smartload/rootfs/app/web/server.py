...
<a href="/docs/changelog"><div class="card"><h2>📝 Changelog v4.0.0</h2><p>Was ist neu? Breaking Changes, neue Features</p></div></a>
...
<p style="text-align:center;margin-top:30px;"><a href="/">← Dashboard</a></p>
    ...
    def _docs_page(self, path: str) -> str:
        ...
        filemap = {"readme": "README.md", "changelog": "CHANGELOG_v4.0.0.md"}
