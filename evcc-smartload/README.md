...
**Unterstützte Provider:** `kia`, `hyundai`, `renault`, `dacia`, `evcc`, `custom`, `manual`
...
|----------|--------------|
| `/health` | Health-Check (`{"status": "ok", "version": "4.0.0"}`) |
